...
if __name__ == "__main__":
    ...
    if 0: # Kode untuk menggabungkan
        ...
        glob_pattern = f"D:\SKRIPSI\DATA RSUI\kurasikreatinin\{excel_file_template.replace('{Bulan}', '*')}"
        df_combined = load_and_combine_excel_data(glob_pattern)
        df_combined.to_excel("D:\SKRIPSI\DATA RSUI\kurasikreatinincombined.xlsx")
